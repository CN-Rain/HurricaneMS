...
public final class PacketProcessor {
	...
	public void registerHandler(RecvPacketOpcode code, MaplePacketHandler handler) {
		try {
			...
			log.error("Check your Recv Packet Opcodes - Something is wrong: " + Integer.toHexString(code.getValue()));
		}
	}
	...
	public void reset(Mode mode) {
		...
		if (mode == Mode.LOGINSERVER) {
			...
			registerHandler(RecvPacketOpcode.OPEN_MERCHANT, new OpenHiredHandler());
		} else {
