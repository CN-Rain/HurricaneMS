...
public class CreateCharHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		IItem eq_beta_hat = MapleItemInformationProvider.getInstance().getEquipById(1002419);
		eq_beta_hat.setPosition((byte) -1);
		equip.addFromDB(eq_beta_hat);
		...
		MapleItemInformationProvider.getInstance().randomizeStats((Equip) eq_weapon);
