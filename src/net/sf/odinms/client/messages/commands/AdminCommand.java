...
import net.sf.odinms.server.life.MapleMonsterQuestInformationProvider;
...
public class AdminCommand implements Command {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        // shutdown
            ...
            MapleMonsterQuestInformationProvider.getInstance().clearDrops();
        ...
        // MapleInventoryManipulator.addFromDrop(c, eq, new String());
            ...
            net.sf.odinms.server.maps.MapleMapFactory gmf = c.getChannelServer().getGmMapFactory();
            net.sf.odinms.server.maps.MapleMap map = gmf.getMap(Integer.parseInt(splitted[1]));
