/*
    ...
    Copyright (C) 2008 Patrick Huy <[Only registered and activated users can see links. ]> 
                       Matthias Butz <[Only registered and activated users can see links. ]>
                       Jan Christian Meyer <[Only registered and activated users can see links. ]>
...
public class MapleInventoryManipulator {
    ...
    static void addFromDrop(MapleClient c, IItem newItem, String string) {
        return ;
    }
